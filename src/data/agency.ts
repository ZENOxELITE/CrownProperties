export const agency = {
  ...
  social: {
    instagram: 'https://instagram.com/crownproperties',
    facebook: 'https://facebook.com/crownproperties',
    linkedin: 'https://linkedin.com/company/crownproperties',
  },
